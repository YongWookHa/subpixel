...
flags = tf.app.flags
flags.DEFINE_integer("epoch", 210, "Epoch to train [25]")
...
flags.DEFINE_string("checkpoint_load_dir", "None", "Directory name to save the checkpoints [checkpoint]")
...
def main(_):
    ...
    with tf.Session() as sess:
        dcgan = DCGAN(sess,
                      ...
                      checkpoint_load_dir=FLAGS.checkpoint_load_dir)
